...
window.onload = () =>{
    console.log( 'onload' )
    document.getElementById("replace").addEventListener("click",inventory.replaceQuantity);
    document.getElementById("input-sec").addEventListener("click",inventory.changeQuantity);
    document.getElementById("containers").addEventListener("click",inventory.getVal);
    document.getElementById("voice-icon").addEventListener("click",inventory.addItems);
    document.getElementById("add-btn").addEventListener("click",inventory.addItemstable);    
}
